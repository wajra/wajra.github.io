...
1. Python Crash Course for Data Analysis (2020) - A 1.5 hour primer on using Python for data analysis and statistics for the Rutgers Data Club. The course materials can be found [here](https://github.com/eoas-data-club/python-workshop) including a recording of the session
